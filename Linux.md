...
- [命令行语法规则](#命令行语法规则)
  ...
  - [重定向](#重定向)
    - [覆写](#覆写)
    - [追加](#追加)
    - [将输出和错误分别重定向](#将输出和错误分别重定向)
    - [将输出和错误集中输出](#将输出和错误集中输出)
    - [丢弃输出](#丢弃输出)
    - [多个命令组重定向](#多个命令组重定向)
  - [子命令（命令替换）](#子命令命令替换)
  - [命令行的Tab补全](#命令行的tab补全)
  ...
  - [命令的返回值](#命令的返回值)
  - [单行多命令](#单行多命令)
  - [Shell子进程和脚本的执行方式](#shell子进程和脚本的执行方式)
- [文件权限](#文件权限)
  - [修改文件/目录所有者/所属组](#修改文件目录所有者所属组)
  - [数字方法修改权限](#数字方法修改权限)
  - [符号方法修改权限](#符号方法修改权限)
  - [文件与目录的权限区别](#文件与目录的权限区别)
- [系统管理常见命令](#系统管理常见命令)
...
- [PowerShell](#powershell)
  ...
  - [筛选数组](#筛选数组)
  - [比较运算符](#比较运算符)
  - [在PowerShell启动时运行的脚本](#在powershell启动时运行的脚本)
  - [CSV](#csv)
  - [JSON](#json)
  - [变量的声明和打印](#变量的声明和打印)
  - [字符串](#字符串-1)
...
D类  | 1110 |  224.xx.xx.xx  ~ 239.xx.xx.xx   组播使用
E类 | 1111  |   240.xx.xx.xx ~ 255.xx.xx.xx   保留网段
