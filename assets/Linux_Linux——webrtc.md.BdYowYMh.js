import{_ as s,c as n,o as p,ae as e}from"./chunks/framework.rTUm5mJw.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"Linux/Linux——webrtc.md","filePath":"Linux/Linux——webrtc.md"}'),i={name:"Linux/Linux——webrtc.md"};function l(t,a,c,d,r,o){return p(),n("div",null,a[0]||(a[0]=[e(`<h2 id="原理" tabindex="-1">原理 <a class="header-anchor" href="#原理" aria-label="Permalink to &quot;原理&quot;">​</a></h2><p>web real-time communication，网页实时通信。主要用于视频通话。</p><p>RTCPeerConnection确保打开线路，打开媒体通道。</p><p>mediaDevices.getUserMedia处理摄像头、话筒、视频和声音。</p><p>RTCDataChannel数据通道的通信。</p><p>SDP，Session Description Protocol会话描述协议，用于在p2p协商时共享彼此的IP地址和端口，以及双方都能使用的音频和视频的编码信息。</p><p>ICE，穿透Nat建立点对点通信的方法，其中会用到STUN和TURN服务器。本地主机将包发送到stun服务器。stun服务器将请求的全球IP地址和端口返回给nat内部的主机。通过这两个步骤，就可以确保通信线路，并获取可以从外部进行通信的地址和端口。stun对于穿透nat必不可少。</p><h2 id="sdp" tabindex="-1">SDP <a class="header-anchor" href="#sdp" aria-label="Permalink to &quot;SDP&quot;">​</a></h2><p>SDP是基于文本的描述协议，描述了自己的媒体信息、能接受的媒体信息。SDP不是网络协议，而是一种在用户之间传递媒体信息所遵循的标准格式，就好比markdown标准一样，规定了标题怎么写、加粗怎么加，大家都按照这个语法写文件即可，这样别人也能看懂你的markdown源码。SDP文本可以附加在HTTP报文的body中传给对方。如下是一个SDP示例：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>v=0</span></span>
...
<span class="line"><span>sdpMid: audio, sdpMLineIndex: 0, candidate:150963819 1 udp 41885439 182.92.80.26 59241 typ relay raddr 42.120.74.91 rport 49618</span></span></code></pre></div><p>双方都会提供自己的candidates给对方，双方商量出一个最优的传输方案。</p><p>candidate与SDP协议一样，也只是一种信息交流所遵循的文本格式。</p><h2 id="stun服务器" tabindex="-1">STUN服务器 <a class="header-anchor" href="#stun服务器" aria-label="Permalink to &quot;STUN服务器&quot;">​</a></h2><p>STUN 服务器的目的就是为用户找到公网地址+端口，让用户可以使用这个公网地址+端口与其他用户进行通信。</p><p>STUN 是非常轻量级的，用户可以使用 docker 建立一个 STUN 服务器。STUN 服务器通常在 3478 端口上运行，TLS 端口为 5349。由于STUN搭建的成本低廉，所消耗的资源也不多，因此有许多免费的STUN服务器。</p><p><img src="https://pic2.zhimg.com/80/v2-93b9f67687ba717100d0ad3220697475_720w.webp" alt="STUN服务器"></p>`,24)]))}const m=s(i,[["render",l]]);export{h as __pageData,m as default};
