import{_ as a,c as n,o as e,ae as t}from"./chunks/framework.rTUm5mJw.js";const k=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"前端/Node.js/Node.js——Socket——Socket服务端和客户端.md","filePath":"前端/Node.js/Node.js——Socket——Socket服务端和客户端.md"}'),p={name:"前端/Node.js/Node.js——Socket——Socket服务端和客户端.md"};function o(c,s,l,i,r,d){return e(),n("div",null,s[0]||(s[0]=[t(`<h2 id="socket服务端" tabindex="-1">Socket服务端 <a class="header-anchor" href="#socket服务端" aria-label="Permalink to &quot;Socket服务端&quot;">​</a></h2><p>Socket通信的服务端代码示例如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const net = require(&#39;net&#39;)</span></span>
...
<span class="line"><span>client.on(&#39;data&#39;,data=&gt;console.log(data.toString().trim()))</span></span></code></pre></div>`,6)]))}const h=a(p,[["render",o]]);export{k as __pageData,h as default};
