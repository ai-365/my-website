import{_ as a,c as n,o as p,ae as l}from"./chunks/framework.rTUm5mJw.js";const u=JSON.parse('{"title":"面相对象","description":"","frontmatter":{},"headers":[],"relativePath":"前端/JavaScript/面向对象.md","filePath":"前端/JavaScript/面向对象.md"}'),e={name:"前端/JavaScript/面向对象.md"};function i(c,s,t,o,d,r){return p(),n("div",null,s[0]||(s[0]=[l(`<h1 id="面相对象" tabindex="-1">面相对象 <a class="header-anchor" href="#面相对象" aria-label="Permalink to &quot;面相对象&quot;">​</a></h1><h3 id="新建类" tabindex="-1">新建类 <a class="header-anchor" href="#新建类" aria-label="Permalink to &quot;新建类&quot;">​</a></h3><p>使用class关键字新建一个类，示例如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>class Example{</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>        }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>虽然不给a、b赋默认值也可以通过语法检测，但给属性赋默认值是一个好的编程习惯。</p>`,15)]))}const b=a(e,[["render",i]]);export{u as __pageData,b as default};
