import{_ as n,c as a,o as p,ae as e}from"./chunks/framework.rTUm5mJw.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"前端/React/React——表单双向绑定.md","filePath":"前端/React/React——表单双向绑定.md"}'),t={name:"前端/React/React——表单双向绑定.md"};function l(c,s,i,o,r,_){return p(),a("div",null,s[0]||(s[0]=[e(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span>
